...
myMinDate.setDate(myDate.getDate() - 1);
var myMaxDate = new Date();
myMaxDate.setDate(myDate.getDate() + 6);
var myFirstDay = myDate.getDay() - 1;
var myStartHour = 0;
var myEndHour = 0;
var myWorkDays = 5;
  ...
  $.widget('ui.weekCalendar', (function() {
    ...
    return {
      options: {
        ...
        */
        firstDayOfWeek: myFirstDay,
        useShortDayNames: false,
        timeSeparator: ' to ',
        startParam: 'start',
        endParam: 'end',
        // businessHours: {start: 8, end: 18, limitDisplay: false},
        businessHours: {start: myStartHour, end: myEndHour, limitDisplay: true},
        ...
        minDate: myMinDate,
        // maxDate: null,
        // minDate: new Date('2019-12-02T00:00:00.000+10:00'),
        maxDate: myMaxDate,
        showHeader: true,
        /*
        buttons: true,
        ...
        */
        ...
        // switchDisplay: {},
        // switchDisplay: {'1 día': 1, '3 días': 3, 'Semana': myWorkDays},
        switchDisplay: {'1 día': 1, '3 días': 3},
        ...
        eventHeader: function(calEvent, calendar) {
          ...
          return calEvent.paciente + '<br/>' + calEvent.expediente + '<br/>' + calEvent.telefono;
        ...
        if (options.buttons) {
            ...
            calendarNavHtml += '<div class=\"ui-widget-header wc-toolbar\">';
              ...
              calendarNavHtml += '<div class=\"wc-nav\">';
                ...
                calendarNavHtml += '<button class=\"wc-today\" id=\"btnHoy\">' + options.buttonText.today + '</button>';
                calendarNavHtml += '<button class=\"wc-next\" id=\"btnSiguiente\">' + options.buttonText.nextWeek + '</button>';
              calendarNavHtml += '</div>';
            calendarNavHtml += '<div class=\"wc-nav\">';
                calendarNavHtml += '<button class=\"wc-add\" id=\"btnAgregar\">Agregar cita médica</button>';
              calendarNavHtml += '</div>';
            ...
            $calendarContainer.find('.wc-nav .wc-add')
              .button({
            ...
            $calendarContainer.find('.wc-nav #btnAgregar')
              .click(function() {
                  if(confirm("¿Desea crear una nueva cita médica?"))
...
//              calendarHeaderHtml+=    "</div>";
  ...
  TODO    if total height for an hour is less than 11px, there is a display problem.
      ...
      _renderEvent: function(calEvent, $weekDay) {
          ...
          eventHtml += '<div class=\"wc-time ui-corner-top\" $#myStyle#$></div>';
          eventHtml += '<div class=\"wc-title\"></div></div>';

          $weekDay.each(function() {
            // Crea copia local para mantener la estructura definida en la instrucción de arriba.
            var localHtml = eventHtml;
            if(calEvent.ausencias === 0){
                localHtml = localHtml.replace("$#myStyle#$",
                                              "style=\"background-color: rgb(76, 217, 100); " +
                                              "border: 1px solid rgb(76, 217, 100); " +
                                              "color: black; " +
                                              "padding: 0; " +
                                              "font-weight: bold;\"");
            } else if(calEvent.ausencias === 1){
                localHtml = localHtml.replace("$#myStyle#$",
                ...
                localHtml = localHtml.replace("$#myStyle#$",
                                              "style=\"background-color: rgb(204, 93, 46); " +
                                              "border: 1px solid rgb(204, 93, 46); " +
                                              "color: black; " +
                                              "padding: 0; " +
                                              "font-weight: bold;\"");
            }
