/*  Nombre.....:  CatalogoMedicamento.java
 *  Descripción:  Carga el registro de la tabla Catalogo_Medicamento_Medico.
...
public class CatalogoMedicamento {
    // Constantes de la clase CatalogoMedicamento.
    private final String PAGINA_WEB = Consts.CATALOGO_MEDICAMENTO_HTML;
    private final String TITULO = Consts.TITULO_LISTA_CATALOGO_MEDICAMENTOS;
    private final String ETIQUETA_EXISTENTE = Consts.ETIQUETA_EXISTENTE_CATALOGO_MEDICAMENTO;
    private final String ETIQUETA_NUEVO = Consts.ETIQUETA_NUEVO_CATALOGO_MEDICAMENTO;
    
    // Variables de la clase CatalogoMedicamento.
    private String serie;
    private int idProveedor;
    private String nombre;
    private String descripcion;
    private int cantidadExistencial;
    private int unidadesCongeladas;
    ...
    // Método constructor de la clase CatalogoMedicamento.
    public CatalogoMedicamento() {
        this.serie = "";
        this.idProveedor = 0;
        this.nombre = "";
        this.descripcion = "";
        this.cantidadExistencial = 0;
        this.unidadesCongeladas = 0;
        this.usuarioModifico = 0;
        this.selectProveedor = "";
    } // Fin del método constructor.
    
    
    // Metodos GET y SET de la clase CatalogoMedicamento.
    ...
    public int getUnidadesCongeladas() {
        return unidadesCongeladas;
    }

    public void setUnidadesCongeladas(int unidadesCongeladas) {
        this.unidadesCongeladas = unidadesCongeladas;
    }
    ...
    // Métodos utilitarios de la clase CatalogoMedicamento.
    // Carga la lista de todos los medicamentos del catálogo, activos e inactivos.
    public String cargarLista(int idCentro, boolean modoVisualizacion, boolean modoEdicion){
      ...
      try {
        // Realiza consulta de medicamentos a la base de datos.
        instanciaListaCatalogo = new $();
        ResultSet resultado = instanciaListaCatalogo.execQry(
            "SELECT Serie, Nombre, CantidadExistencial, UnidadesCongeladas " +
        ...
        if( resultado.next() ){
          respuesta =
                ...
                "{ \"error\" : false, " +
                "  \"mensaje\" : \"\", " +
                // Información recuperada de la tabla Catalogo_Medicamento_Medico.
                "  \"elementosHTML\": \"" +
                "            <h5 class='center'>" + TITULO +
                ...
                "                  <th onclick='sortTable(3)' style='cursor:pointer' id='cuantificableCol' class='center'>Unidades<br/>Congeladas<i></th>" +
          ...
          do{
            // Si existen resultados crea arreglo JSON para mostrar la lista del catálogo de medicamentos.
            this.setSerie(resultado.getString("Serie"));
            this.setNombre(resultado.getString("Nombre"));
            this.setCantidadExistencial(resultado.getInt("CantidadExistencial"));
            this.setUnidadesCongeladas(resultado.getInt("UnidadesCongeladas"));
    ...
    // Carga el registro del catálogo de medicamento con el código proporcionado.
        ...
        try{
            if(numeroDeSerie.length() > 0){
                ...
                String myQuery =
                    ...
                    "       CantidadExistencial, UnidadesCongeladas, UsuarioModifico " +
                    "FROM Catalogo_Medicamento " +
                    "WHERE Serie = ?;";  

                PreparedStatement psMedicamento = instanciaBD.prepStatement(myQuery);      
                psMedicamento.setString(1, numeroDeSerie);
                ...
                setNombre("");
                setDescripcion("");
                setCantidadExistencial(0);
                setUnidadesCongeladas(0);
    ...
    public String toJSON(){
        ...
        if (getSerie().equals("-1"))
            mensajeError = "Ocurrió un error al cargar el registro del catálogo de medicamentos.";
        ...
        return
            ...
            "   \"codigo\": \"" + getSerie() + "\", " +
            "   \"nombre\": \"" + getNombre() + "\", " +
            "   \"cantidad\": " + getCantidadExistencial() + ", " +
            "   \"descripcion\": \"" + getDescripcion() + "\", " +
            "   \"unidadesCongeladas\": " + getUnidadesCongeladas() + ", " +
    ...
    private String toHTML() {
        return "<tr style='border: none;' class='resaltar'>" +
               ...
               "  <td style='padding-top: 1%; padding-bottom: 1%; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;' class='center'>" + getCantidadExistencial() + "</td>" +
               "  <td style='padding-top: 1%; padding-bottom: 1%; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;' class='center'>" + getUnidadesCongeladas() + "</td>" +
...
} // Fin de la clase CatalogoMedicamento.